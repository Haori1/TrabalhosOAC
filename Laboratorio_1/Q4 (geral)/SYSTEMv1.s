...
loop1printInt:	div 	t4, a0, t2			# divide por 10
		rem 	t3, a0, t2			# resto
...
printChar:	auipc t4, 0x0000F
	addi t4, t4, 0xF00     
	and    t5, a3, t4         # cor fundo
	auipc t4, 0x00000
	addi t4, t4, 0x0FF
    	and    t6, a3, t4             	# cor frente
...
ehposprintFloat: sb 	t0, 0(s0)			# coloca sinal no buffer
		...
		abs.s 	f0, f12		# f0 recebe o m�dulo  de x
		lui 	t0, 0x3F80
		...
		mov.s 	f2, f10		# f2  fator de multiplica�ao = 10
...
cont1printFloat: 	mov.s 	f4, f0			# inicia com o numero x 
		 	mov.s 	f3, f1			# contador come�a em 1
